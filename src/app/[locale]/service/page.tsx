    ...
    <div className="">
      ...
      <div className="services px-5 py-14 container mx-auto flex flex-col gap-8">
        ...
        <section id="thiet-ke-website">
          <h2 className="text-3xl text-bold text-green-600 border-b  pb-2 mb-6">
            Thiết kế Website
          </h2>
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              Phân tích và nghiên cứu yêu cầu của khách hàng Thiết kế giao diện
              đồ họa (UI/UX)
            </li>
            <li>
            ...
            <li>
              Tối ưu hóa trang web cho thiết bị di động (responsive design)
            </li>
        ...
        <section id="thiet-ke-he-thong">
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-4">
            Thiết kế hệ thống là quá trình lập kế hoạch và cấu trúc các thành
            phần của hệ thống thông tin để đáp ứng các yêu cầu cụ thể của một tổ
            chức hoặc doanh nghiệp. Quá trình này bao gồm việc phân tích nhu
            cầu, xác định các thành phần phần cứng và phần mềm cần thiết, và
            thiết lập các giao thức và tiêu chuẩn hoạt động. Một hệ thống được
            thiết kế tốt sẽ:
          </p>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <section id="giai-phap-cntt">
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-4">
            Giải pháp Công nghệ Thông tin (CNTT) là việc áp dụng công nghệ để
            giải quyết các vấn đề kinh doanh và cải thiện hiệu quả hoạt động của
            doanh nghiệp. Các giải pháp CNTT bao gồm một loạt các dịch vụ và
            công nghệ như phần mềm quản lý doanh nghiệp (ERP), hệ thống quản lý
            quan hệ khách hàng (CRM), hạ tầng mạng, bảo mật thông tin, và các
            dịch vụ đám mây. Lợi ích của việc triển khai giải pháp CNTT bao gồm:
          </p>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <section id="thiet-ke-app-mobile">
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-4">
            ...
            dụng phần mềm chạy trên thiết bị di động như điện thoại thông minh
            và máy tính bảng. Quá trình này bao gồm việc thiết kế giao diện
            người dùng (UI/UX), lập trình chức năng, và thử nghiệm ứng dụng trên
            nhiều nền tảng di động như iOS và Android. Một ứng dụng di động chất
            lượng cao sẽ:
          </p>
          <ul className="list-disc pl-5 space-y-2">
